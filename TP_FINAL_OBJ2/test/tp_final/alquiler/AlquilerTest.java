...
class AlquilerTest {
	/*
	 * Alquiler alquiler; private Inmueble inmueble; private Reserva reserva1;
	 * private Reserva reserva2; private Reserva reserva3; private
	 * PoliticaDeCancelacion politica;
	 * 
	 * private Usuario propietario; private Usuario sub;
	 * 
	 * @BeforeEach void setUp() throws Exception { inmueble = mock(Inmueble.class);
	 * 
	 * propietario = mock(Usuario.class);
	 * 
	 * sub = mock(Usuario.class);
	 * 
	 * reserva1 = mock(Reserva.class); reserva2 = mock(Reserva.class); reserva3 =
	 * mock(Reserva.class);
	 * 
	 * politica = new SinCancelacion();
	 * 
	 * alquiler = new Alquiler(propietario, inmueble, LocalTime.of(10, 0),
	 * LocalTime.of(14, 30), MedioDePago.EFECTIVO, 200d, politica); }
	 * 
	 * @Test void getterPrecioBaseTest() { assertEquals(alquiler.getPrecioBase(),
	 * 200d); }
	 * 
	 * @Test void setterPrecioBaseTest() { alquiler.setPrecioBase(500);
	 * assertEquals(alquiler.getPrecioBase(), 500d); }
	 * 
	 * @Test void getterYSetterFechaEntrada() { LocalDate entrada =
	 * LocalDate.of(2024, 11, 3); alquiler.setFechaDeEntrada(entrada);
	 * 
	 * assertEquals(entrada, alquiler.getFechaCheckIn()); }
	 * 
	 * @Test void getterYSetterFechaSalida() { LocalDate salida = LocalDate.of(2024,
	 * 11, 4); alquiler.setFechaDeSalida(salida);
	 * 
	 * assertEquals(salida, alquiler.getFechaDeCheckOut()); }
	 * 
	 * @Test void getterYSetterCheckIn() { LocalTime checkIn = LocalTime.of(8, 0);
	 * alquiler.setCheckIn(checkIn);
	 * 
	 * assertEquals(checkIn, alquiler.getCheckIn()); }
	 * 
	 * @Test void getterYSetterCheckOut() { LocalTime checkOut = LocalTime.of(16,
	 * 0); alquiler.setCheckOut(checkOut);
	 * 
	 * assertEquals(checkOut, alquiler.getCheckOut()); }
	 * 
	 * @Test void getterYSetterMedioPago() { MedioDePago medioDePago =
	 * MedioDePago.DEBITO; alquiler.setMedioDePago(medioDePago);
	 * 
	 * assertEquals(medioDePago, alquiler.getMedioDePago()); }
	 * 
	 * @Test void confirmarReservaTest() {
	 ...
	 * 
	 * assertEquals(null, alquiler.getFechaCheckIn()); assertEquals(null,
	 * alquiler.getFechaDeCheckOut());
	 * 
	 ...
	 * 
	 * @Test void getterYSetterEstadoTest() { EstadoDeAlquiler libre = new Libre();
	 ...
	 * 
	 * @Test void addYGetterPreciosTemporadas() {
	 * 
	 ...
	 * 
	 * @Test void addReservaYGetColaDeEsperaTest() {
	 ...
	 * 
	 * @Test void subscriptoresTest() {
	 * 
	 * when(reserva1.getfechaEntrada()).thenReturn(LocalDate.of(2024, 11, 1));
	 * when(reserva1.getfechaSalida()).thenReturn(LocalDate.of(2024, 11, 5));
	 * 
	 * alquiler.reservar(reserva1); alquiler.confirmarReserva(reserva1);
	 * 
	 ...
	 * 
	 * @Test void alquilarYCancelarReservaEnEstadoLibreTest() {
	 * when(reserva1.getfechaEntrada()).thenReturn(LocalDate.of(2024, 11, 1));
	 * when(reserva1.getfechaSalida()).thenReturn(LocalDate.of(2024, 11, 5));
	 * 
	 ...
	 * 
	 * alquiler.reservar(reserva1); assertEquals(alquiler.getcolaDeEspera().get(0),
	 * reserva1); alquiler.reservar(reserva2); alquiler.reservar(reserva3);
	 ...
	 * assertEquals(alquiler.getcolaDeEspera().get(0), reserva2); }
	 * 
	 * @Test void alquilarYCancelarReservaEnEstadoAlquiladoTest() {
	 * 
	 ...
	 * when(reserva3.getfechaSalida()).thenReturn(LocalDate.of(2024, 11, 5));
	 * 
	 * alquiler.reservar(reserva2); alquiler.reservar(reserva3);
	 * 
	 * assertEquals(alquiler.getcolaDeEspera().get(0), reserva1);
	 * assertEquals(alquiler.getcolaDeEspera().size(), 3);
	 * 
